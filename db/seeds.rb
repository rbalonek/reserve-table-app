...
# Guest.create(name:"Bob", email:"bob@bob.com", phone:'585-721-2210', seat_id:1 )
# Guest.create(name:"Bill", email:"Bill@bob.com", phone:'585-721-0000', seat_id:6 )
# Guest.create(name:"Jeff", email:"Jeff@bob.com", phone:'585-721-1111', seat_id:11 )
# Guest.create(name:"Skylar", email:"Skylar@bob.com", phone:'585-721-2222', seat_id:16 )
# Guest.create(name:"Goeff", email:"Goeff@bob.com", phone:'585-721-3333', seat_id:21 )
